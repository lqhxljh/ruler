...
//            holder.ll_last_day_tip.setVisibility(View.GONE);
    ...
    public void setAlarmTimeSlot(List<TimeSlot> alarmTimeSlot) {
    ...
    public void setAlarmBg(int color) {
        this.alarmBgColor = color;
    }

    public void setVideoBg(int color) {
        this.videoBgColor = color;
    }

    public void setVisitorBg(int color) {
        this.visitorBg = color;
    }
...
//        private ImageView ivRight, iv_tip_right;
        ...
        public RulerViewHolder(View itemView) {
            super(itemView);
            parentView = itemView;
            view = itemView.findViewById(R.id.riv_ruler_item);
            view.setAlarmBg(alarmBgColor);
            view.setVisitorBg(visitorBg);
            view.setVideoBg(videoBgColor);
//            ll_next_day_tip = itemView.findViewById(R.id.ll_next_day_tip);
//            ll_last_day_tip = itemView.findViewById(R.id.ll_last_day_tip);
//            ivLeft = itemView.findViewById(R.id.iv_left);
//            ivRight = itemView.findViewById(R.id.iv_right);
//            iv_tip_left = itemView.findViewById(R.id.iv_tip_left);
//            iv_tip_right = itemView.findViewById(R.id.iv_tip_right);
        }
    }
